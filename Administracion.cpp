...
void Administracion::inicializarDatos() {
    ...
    cout << "El propietario 1 ha sido creado exitosamente\n";
    Propietario *persona2 = new Propietario();
    cout << "El propietario 2 ha sido creado exitosamente\n";
    Propietario *persona3 = new Propietario();
    cout << "El propietario 3 ha sido creado exitosamente\n";
    Propietario *persona4 = new Propietario();
    cout << "El propietario 4 ha sido creado exitosamente\n";

    Propiedad *prop1 = new Propiedad();
    cout << "La propiedad 1 ha sido creado exitosamente\n";
    Propiedad *prop2 = new Propiedad();
    cout << "La propiedad 2 ha sido creado exitosamente\n";
    Propiedad *prop3 = new Propiedad();
    cout << "La propiedad 3 ha sido creado exitosamente\n";
    Propiedad *prop4 = new Propiedad(); // Automaticamente al constructor x defecto
    cout << "La propiedad 4 ha sido creado exitosamente\n";

    CuartoUtil *cuarto1 = new CuartoUtil();
    cout << "El cuarto 1 ha sido creado exitosamente\n";
    CuartoUtil *cuarto2 = new CuartoUtil();
    cout << "El cuarto 2 ha sido creado exitosamente\n";
    CuartoUtil *cuarto3 = new CuartoUtil();
    cout << "El cuarto 3 ha sido creado exitosamente\n";
...
void Administracion::generarReportePropiedades()
{
    ...
    for (int i = 0; i < propietarios.size(); i++)
    {
        ...
        {
            cout << "  - Propiedad ID: "
                 << propietarios[i]->getPropiedad()->getNumIdentificacion()
                 << ", Piso: "
                 << propietarios[i]->getPropiedad()->getPiso()
                 << ", Área: "
                 << propietarios[i]->getPropiedad()->getAreaPropiedad()
                 << "m²" << endl;
            ...
            if (propietarios[i]->getPropiedad()->getCuartoUtil() != nullptr)
            {
                if (propietarios[i]->getPropiedad()->getCuartoUtil()->isEstaTerminado())
                {
                    cout << "  - Cuarto útil: Terminado" << endl;
                }
                else
                {
                    cout << "  - Cuarto útil: No terminado" << endl;
                }
            }
            else
            {
                cout << "  - Sin cuarto útil" << endl;
            }

            total += propietarios[i]->getPropiedad()->calcularRecargo(
                cobroAscensor, costoBase, recargo);
        }

        cout << "-------------------------------" << endl;
    }

    cout << "Total administración recaudada: "
         << total << endl;
}

void Administracion::propietarioMayorAdministracion()
{
    float mayor = 0;
    int pos = -1;
    ...
    for(int i = 0; i < propietarios.size(); i++)
    {
        ...
        {
            float valor =
            propietarios[i]->getPropiedad()->calcularRecargo(
                cobroAscensor,
                costoBase,
                recargo
            );
    ...
    if(pos != -1)
    {
        cout << "Propietario que paga mas administracion: "
             << propietarios[pos]->getNombre()
             << endl;
...
void Administracion::propiedadMenorArea()
{
    int pos = -1;
    float menor = 0;
    ...
    if(pos != -1)
    {
        cout << "Propiedad con menor area: "
             << endl;

        cout << "ID: "
             << propietarios[pos]->getPropiedad()->getNumIdentificacion()
             << endl;
...
void Administracion::reportePisosYMayorAdministracion()
{
    int posMayorPiso = -1;
    int posMenorPiso = -1;
    int posMayorAdmin = -1;
    ...
    for(int i = 0; i < propietarios.size(); i++)
    {
        if(propietarios[i]->getPropiedad() != nullptr)
        {
            ...
            if(propietarios[i]->getPropiedad()->getPiso() > mayorPiso)
            {
                mayorPiso =
                propietarios[i]->getPropiedad()->getPiso();
            ...
            if(propietarios[i]->getPropiedad()->getPiso() < menorPiso)
            {
                menorPiso =
                propietarios[i]->getPropiedad()->getPiso();
    ...
    cout << "Propietario en piso mas alto: "
         << propietarios[posMayorPiso]->getNombre()
         << endl;

    cout << "Propietario en piso mas bajo: "
         << propietarios[posMenorPiso]->getNombre()
         << endl;

    cout << "Propietario con mayor administracion: "
         << propietarios[posMayorAdmin]->getNombre()
         << endl;
}